...
class AdminAlertAdaptor(private val options: FirebaseRecyclerOptions<Alert>, private val listener: IViewEditAlertListener) : FirebaseRecyclerAdapter<Alert, AdminAlertAdaptor.ViewHolder>(options) {
